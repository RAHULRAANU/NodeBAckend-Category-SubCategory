...
router.route("/category/:id").get(getCategory_id).put(updateCategory).delete(deleteCategory);
  
//@ For delete update and read by id SubCategory
router.route("/subcategory/:id").get(getSubCategory_id).put(updateSubCategory).delete(deleteSubCategory);
